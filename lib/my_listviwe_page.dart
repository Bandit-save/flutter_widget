...
class MyListviwePage extends StatefulWidget {
  const MyListviwePage({super.key});

  @override
  State<MyListviwePage> createState() => _MyListviwePageState();
}

class _MyListviwePageState extends State<MyListviwePage> {
  var rnd = Random();
  var titleText = ['Star', 'Heart', 'WiFi', 'Bluetooth','Gear'];
  ...
  Widget buildListItem(BuildContext ctx, int index){
    return ListTile(
      ...
      trailing: trailingWidget(ctx, index), //ไอคอนที่อยู่ด้านท้าย
